  ...
  return (
    <div className="animate-slide-in">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        {[
          { label: 'Open Reports',  value: openCount,     color: 'text-red-400',    bg: 'bg-red-500/10',    ring: 'ring-red-500/20'    },
          { label: 'Under Review',  value: reviewingCount, color: 'text-amber-400', bg: 'bg-amber-500/10',  ring: 'ring-amber-500/20'  },
          { label: 'Resolved',      value: reports.filter((r) => r.status === 'resolved').length, color: 'text-emerald-400', bg: 'bg-emerald-500/10', ring: 'ring-emerald-500/20' },
          ...
          <div className="table-wrapper">
            <table className="table">
              ...
              <tbody>
                {filtered.map((r) => (
                  <tr key={r.id}>
                    <td className="font-medium text-surface-200">{r.type}</td>
                    <td className="text-surface-400">{r.item}</td>
